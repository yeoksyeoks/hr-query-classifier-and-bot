...
# Install pysqlite3-binary if not available
try:
    import pysqlite3
except ImportError:
...
try:
    ...
    st.error(f"Import Error: Make sure hr_classifier_py.py and hr_rag_bot_py.py are in the same directory. Error: {str(e)}")
