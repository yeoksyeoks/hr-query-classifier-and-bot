...
def apply_soothing_colors():
    """Apply soothing colors to specific UI elements"""
    st.markdown("""
    <style>
    /* Button styling with soothing teal */
    .stButton > button {
    ...
    /* Progress bar with soft blue */
    .stProgress > div > div {
        background-color: #6B9BD8;
    }
    
    /* Multiselect tags with muted purple */
    .stMultiSelect > div > div > div {
        background-color: #8B7EC8;
        color: white;
    }
    
    /* Radio buttons with sage green */
    ...
    /* File uploader with soft lavender */
    .stFileUploader > div > div {
        border: 2px dashed #9B8BBB;
    }
    
    .stFileUploader > div > div:hover {
        border-color: #7A6B9A;
        background-color: rgba(155, 139, 187, 0.05);
    }
    
    /* Success messages with warm mint */
    .stSuccess {
        background-color: rgba(106, 176, 155, 0.1);
        border-left: 4px solid #6AB09B;
    }
    
    /* Sidebar with soft background */
    .css-1d391kg {
        background-color: #F7F9F8;
    }
    
    /* Metric containers with gentle styling */
    [data-testid="metric-container"] {
        background-color: #FAFBFA;
        border: 1px solid #E8EDE9;
        padding: 1rem;
        border-radius: 8px;
        box-shadow: 0 1px 3px rgba(106, 176, 155, 0.1);
    }
    </style>
